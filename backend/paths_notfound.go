...
// pathNotFound is the catch-all: "anything else on the KV-
...
// family (the catch-all explicitly excludes it) whenever an
...
func pathNotFound(b *Backend) *framework.Path {
	...
	return &framework.Path{
		...
		HelpSynopsis: "Catch-all 404 for the KV-emulation surface.",
	}
}
